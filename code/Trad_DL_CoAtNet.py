...
# labeled_data_dir = 'D:/PHD/DSB3/stage1/stage1/All_Dataset_used'
# labeled_csv_path = 'D:/PHD/DSB3/stage1/stage1/All_Dataset_used.csv'

labeled_data_dir = 'Dataset 790'
labeled_csv_path = 'Dataset 790.csv'
labeled_images = []
image_labels = []  # Distinguishing image labels from CSV labels
...
# Step 4: Build Simplified CoAtNet Model
...
# EarlyStopping callback to stop training when validation loss has stopped improving
...
final_train_accuracy = training_accuracy[-1]  # Get the last value of the training accuracy
final_validation_accuracy = validation_accuracy[-1]  # Get the last value of the validation accuracy
